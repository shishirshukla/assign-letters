...
2. Set `ASSIGNLETTERS_API_URL` to the HTTPS endpoint that should receive saved assignments (a different host than this app). The task pane POSTs there; this app only logs the result.
